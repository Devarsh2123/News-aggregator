...
def home(request):
    news_api = requests.get("http://newsapi.org/v2/top-headlines?country=in&apiKey=9144bd1952654f95a5597b25a44e8e59")
    # news_api = requests.get("https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=1d5fe151065b4c0dba3d7b08fd057cd1")
...
@login_required(login_url='login')
def bnews(request):
    b_news_api = requests.get("http://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=9144bd1952654f95a5597b25a44e8e59")
    # b_news_api = requests.get("https://newsapi.org/v2/everything?q=tesla&from=2022-10-12&sortBy=publishedAt&apiKey=1d5fe151065b4c0dba3d7b08fd057cd1")
